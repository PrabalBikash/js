...
this._leftBtn.layoutAlign="right";
...
this._rightBtn.set("disabled",_33<=_34.min);
this._leftBtn.set("disabled",_33>=_34.max);
}});
...
return false;
	...
	_1.forEach(_37.getChildren(),function(_38){
		var cc = _38;
		//var dropDown=new _f({id:this.containerId+"_menu",dir:this.dir,lang:this.lang,textDir:this.textDir});
		if(_38.params.id!="_main_tab_def"){
        	_37.removeChild(_38);
