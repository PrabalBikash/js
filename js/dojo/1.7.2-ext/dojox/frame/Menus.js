...
define(["dojo/_base/declare",
	...
	"../utils/ajax",
	"../utils/toTreeObj",
	"./Menu"],function($declare,$_Templated,$_Widget,$lang,$ajax,$toTreeObj,$Menu){
	return $declare("capec.frame.Menus",[$_Widget,$_Templated],{
		_tabs: null,
		...
		_onDataLoaded: function($data){
			...
			if(__treeObj.children){
				for(var __i_3=0,__item_3; __item_3=__treeObj.children[__i_3]; __i_3++){
					var __menu = new $Menu({
						menuName: __item_3.modulename,
						data: __item_3,
						parent: this
					});
					__menu.placeAt(this.domNode);
				}
			}
